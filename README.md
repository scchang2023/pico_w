...
- 外觀圖
![Alt text](./doc/icons/pico_overview.jpg)
...
![Alt text](./doc/icons/pico_pin.png)
...
![Alt text](./doc/icons/pio_usb.png)
...
![Alt text](./doc/icons/flash_micropython_1.png)
1. 按照底下的步驟操作，按下「安裝」，Thonny IDE會自動下載韌體然後燒入Pico W板。
![Alt text](./doc/icons/flash_micropython_2.png)
1. 燒錄完成後，按下「關閉」鈕，此時開發板已自動重啟並且改用序列埠通訊方式連上電腦。
![Alt text](./doc/icons/flash_micropython_3.png)
1. 按下「確認」，從Thonny IDE的「互動環境（Shell）」可看到已成功連上Pico W開發板。
![Alt text](./doc/icons/flash_micropython_4.png)

## 內建硬體

### [Timer 計時器](./doc/0_01_timer/README.md)

### [RTC(Real Time Clock) 實時時鐘](./doc/0_02_RTC/README.md)

### [WTD(Watch Dog Timer) 重新啟動](./doc/0_03_WDT/README.md)

### [build-in LED 內建LED](./doc/0_04_LED/README.md)

### [ADC 內建溫度感測器](./doc/0_05_ADC/README.md)

### [IRQ 中斷](./doc/0_06_IRQ/README.md)

### [Thread 執行緒使用](./doc/0_07_thread/README.md)

### [Wifi 連線](./doc/0_08_wifi/README.md)

### [Wifi 連線 - 使用 module 方式](./doc/0_09_wifi/README.md)

### [當作 Web Server 使用](./doc/0_10_web_server/README.md)

## 外接硬體

### [Btton & LED](./doc/1_01_button&led/README.md)
